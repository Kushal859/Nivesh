    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tier', models.CharField(choices=[('free', 'Free'), ('pro', 'Pro — ₹299/month'), ('ca', 'CA/Business — ₹2,999/month')], default='free', max_length=10)),
                ('tier_expires', models.DateTimeField(blank=True, null=True)),
